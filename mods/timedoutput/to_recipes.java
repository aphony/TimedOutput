...
public class to_recipes {
	...
	public static void initRecipes() {
		...
		GameRegistry.addShapelessRecipe(new ItemStack(TimedOutput.DelayedLamp_5MinOff), new ItemStack(TimedOutput.ZeroDelayLampOff));
		GameRegistry.addShapelessRecipe(new ItemStack(TimedOutput.CarrierLampOff), new ItemStack(TimedOutput.DelayedLamp_5MinOff));
