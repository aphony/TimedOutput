...
public abstract class TimedPressurePlateBase extends Block
{
    private String field_94356_a;

    public TimedPressurePlateBase(int par1, String par2Str, Material par3Material)
    {
        super(par1, par3Material);
        this.field_94356_a = par2Str;
        this.setCreativeTab(TimedOutput.TimedOutputTab);
