...
public class DelayedLamp_5Min extends Block
{
    /** Whether this lamp block is the powered version. */
    private final boolean powered;

    public DelayedLamp_5Min(int par1, boolean par2)
    {
    ...
    public void onBlockAdded(World par1World, int par2, int par3, int par4)
    {
        if (!par1World.isRemote)
        {
            ...
            {
                par1World.setBlock(par2, par3, par4, TimedOutput.DelayedLamp_5MinOn.blockID, 0, 2);
            }
        }
    }
    ...
    public void updateTick(World par1World, int par2, int par3, int par4, Random par5Random)
    {
        ...
        {
            par1World.setBlock(par2, par3, par4, TimedOutput.DelayedLamp_5MinOff.blockID, 6000, 2);
        }
    }
    ...
    {
        return TimedOutput.DelayedLamp_5MinOff.blockID;
    }
