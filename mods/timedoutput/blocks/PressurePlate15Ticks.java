...
public class PressurePlate15Ticks extends TimedPressurePlateBase
{
    /** The mob type that can trigger this pressure plate. */
    private EnumMobType triggerMobType;

    public PressurePlate15Ticks(int par1, String par2Str, Material par3Material, EnumMobType par4EnumMobType)
    {
