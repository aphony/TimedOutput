...
public class PressurePlate40Ticks extends TimedPressurePlateBase
{
    /** The mob type that can trigger this pressure plate. */
    private EnumMobType triggerMobType;

    public PressurePlate40Ticks(int par1, String par2Str, Material par3Material, EnumMobType par4EnumMobType)
    {
